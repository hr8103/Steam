...
// ★★★ 1. Steam 图标 SVG 路径 (键名已修改为简体中文以匹配数据) ★★★
const steamIcons = {
...
const displayedLanguages = computed(() => {
  if (showAllLangs.value) {
    return parsedLanguages.value
  }
  return parsedLanguages.value.slice(0, 3)
})
        ...
        <div class="right-sidebar-wide">
          ...
          <div class="block langs">
            ...
            <table class="lang-tbl">
              ...
              <tbody>
              <tr v-for="l in displayedLanguages" :key="l.name">
            ...
            <div
                class="more-link"
                v-if="!showAllLangs && parsedLanguages.length > 3"
          ...
          <div class="block meta" v-if="game.metacriticScore > 0">
            ...
            <div class="meta-logo">
              ...
              <a :href="game.metacriticUrl" target="_blank" class="meta-link">阅读游戏评測</a>
            </div>
          </div>
...
.block-head { color: #fff; margin-bottom: 10px; font-size: 14px; }
...
/* 更多语言链接按钮 */
.more-link { color: #66c0f4; cursor: pointer; margin-top: 5px; font-size: 12px; }

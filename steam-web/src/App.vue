    ...
    <div class="global-header">
      <div class="content-width global-nav">
        <div class="global-actions">
          ...
          <template v-else>
            <span class="user-welcome">欢迎回来, {{ user.name }}</span>
    ...
    <header class="steam-header">
      <div class="content-width header-inner">
        <div class="logo-wrapper" @click="$router.push('/')">
          <img src="https://store.cloudflare.steamstatic.com/public/shared/images/header/logo_steam.svg?t=962016" class="steam-logo-img"/>
        </div>
        ...
        <nav class="nav-links">
          ...
          <RouterLink v-if="user && user.role === 'admin'" to="/admin" class="nav-item admin-link">
            后台管理
          </RouterLink>
        </nav>
